...
namespace Knv.MSIG181018
{
    ...
    public interface IMainForm
    {
        ...
        void CursorDefault();
        string Text { get; set; }
        string StatusLoadTime { get; set; }
        string StatusFileLastModified { get; set; }
    ...
    public partial class MainForm : Form, IMainForm
    {
        ...
        public string StatusLoadTime
        {
            get { return toolStripStatusLabelFileLoadTime.Text;  }
            set { toolStripStatusLabelFileLoadTime.Text = value; }
        }

        public string StatusFileLastModified
        {
            get { return toolStripStatusLabelFileLoadTime.Text; }
            set { toolStripStatusLabelFileLoadTime.Text = value; }
        }
